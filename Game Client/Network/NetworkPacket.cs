    ...
    public static class NetworkPacket {
        public static void ProcessPacket(NetIncomingMessage msg) {
            ...
            switch (index) {
                ...
                case (int)PacketList.Ping: GameData.Ping(); break;
                ...
                case (int)PacketList.LS_CL_Maintenance: Message.Show(PacketList.LS_CL_Maintenance); break;
                case (int)PacketList.LS_CL_AccountBanned: Message.Show(PacketList.LS_CL_AccountBanned); break;
                case (int)PacketList.LS_CL_AccountDisabled: Message.Show(PacketList.LS_CL_AccountDisabled); break;
                case (int)PacketList.LS_CL_InvalidNamePass: Message.Show(PacketList.LS_CL_InvalidNamePass); break;
                case (int)PacketList.LS_CL_AlreadyLoggedIn: Message.Show(PacketList.LS_CL_AlreadyLoggedIn); break;
                case (int)PacketList.LS_CL_SendPlayerHexID: LoginData.HexID(msg.ReadString()); break;
                case (int)PacketList.LS_CL_ServerList: LoginData.ServerList(msg); break;
                ...
                case (int)PacketList.GameServer_SendNpc: GameData.ReceiveNpc(msg); break;
                ...
                //usa o mesmo pacote para receber o chat
                case (int)PacketList.Client_WorldServer_GlobalChat: WorldData.AddTextChat(msg); break;
                case (int)PacketList.WS_CL_PlayerMessage: WorldData.AddTextChat(msg); break;
               ...
               // case (int)PacketList.WorldServer_Client_GuildInfo: WorldServerData.WorldGuildInfo(msg); break;
                ...
                case (int)PacketList.GameServer_NpcMove: GameData.NpcMove(msg); break;
            }
        }
    }
}
