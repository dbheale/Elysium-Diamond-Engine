...
namespace Elysium_Diamond.Network {
    public static class NetworkSocket {
        ...
        /// <param name="socket"></param>
        /// <returns></returns>
        public static bool Connected(SocketEnum socket) {
        ...
        /// </summary>
        /// <param name="socket"></param>
        public static void Disconnect(SocketEnum socket) {
        ...
        /// <param name="socket"></param>
        /// <param name="data"></param>
        public static void SendData(SocketEnum socket, NetOutgoingMessage data) {
        ...
        public static void SendData(SocketEnum socket, NetOutgoingMessage data, NetDeliveryMethod delivery) {
