...
namespace AccountEditor {
    public partial class NewCharacter : DarkForm {
        ...
        /// <summary>
        /// Verifica os dados e insere um novo personagem
        /// </summary>
        ...
        private void strip_save_Click(object sender, EventArgs e) {
            ...
            if (!CharacterDB.IsSlotFree(_accountID, _charSlot)) {
                DarkMessageBox.ShowError ("O slot já está sendo usado.", "Erro");
                return;
            }
            ...
            if (Static.Classes.Count == 0) { return; }
        ...
        public void Show(int accountID, int charslot) {
            ...
            if (Static.Classes.Count > 0) { list_classes.SelectItem(0); }
        }
