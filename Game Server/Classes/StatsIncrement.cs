...
namespace GameServer.Classes {
    public sealed class StatsIncrement {
        ...
        private int[] inc_AttributeLight = new int[MAX_STATS];
        private int[] inc_AttributeDark = new int[MAX_STATS];
        ...
        public void SetIncrementStat(StatType stat, string data) {
            switch (stat) {
                ...
                case StatType.AttributeWind:
                    ...
                    break;
                case StatType.AttributeLight:
                    SetIncrementStat(inc_AttributeLight, data);
                    break;
                case StatType.AttributeDark:
                    SetIncrementStat(inc_AttributeDark, data);
                    break;
        ...
        /// </summary>
        /// <param name="stat"></param>
        /// <param name="value">stats do personagem</param>
        /// <returns></returns>
        public int GetIncrementStat(StatType stat, params int[] value) {
            switch (stat) {
                ...
                case StatType.AttributeLight: return GetIncrementStat(inc_AttributeLight, value);
                case StatType.AttributeDark: return GetIncrementStat(inc_AttributeDark, value);
        ...
        /// </summary>
        public void Clear()  {
            Strenght = Dexterity = Agility = Constitution = Intelligence = Wisdom = Will = Mind = Points = 0;
