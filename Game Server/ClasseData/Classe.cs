...
namespace GameServer.ClasseData {
    public class Classe : StatsBase {
        ...
        public int GetPlayerStat(StatType stat, PlayerData pData, params int[] itemStats) {
            ...
            // (pData.Level menos 1 leve, pois os stats já são inseridos quando o char é criado.
            ...
            //stats base + level * incremento por level
            switch (stat) {
                case StatType.Strenght: return pData.BaseStrenght;
                case StatType.Dexterity: return pData.BaseDexterity;
                case StatType.Agility: return pData.BaseAgility;
                case StatType.Constitution: return pData.BaseConstitution;
                case StatType.Intelligence: return pData.BaseIntelligence;
                case StatType.Wisdom: return pData.BaseWisdom;
                case StatType.Will: return pData.BaseWill;
                case StatType.Mind: return pData.BaseMind;
                case StatType.Charisma: return pData.BaseCharisma;
                case StatType.MaxHP: return HP + Increment.GetIncrementStat(StatType.MaxHP, value);
                case StatType.MaxMP: return MP + Increment.GetIncrementStat(StatType.MaxMP, value);
                case StatType.MaxSP: return SP + Increment.GetIncrementStat(StatType.MaxSP, value);
                case StatType.RegenHP: return RegenHP + Increment.GetIncrementStat(StatType.RegenHP, value);
